            ...
            <Container>
                <div className="contact_us_container">
                    ...
                    <p className="description" style={{ color: "#fff" }}>
                        ...
                        elit. Modi natus veniam eveniet id, distinctio ipsa
                        rerum veritatis porro ea soluta.
                        <br />
                        Lorem ipsum dolor sit amet consectetur, adipisicing
                        elit. Assumenda, ratione.
                    </p>
                        ...
                        <Row className="g-2 gy-4">
                            ...
                            <div>
                                ...
                                <Form.Select onChange={categoryDropdownChange}>
                                    ...
                                    <option value="TV - Video - Audio">
                                        TV - Video - Audio
                                    </option>
                                    <option value="Tablets Land">
                                        Tablets
                                    </option>
                                    <option value="Tablets Land">
                                        Laptops
